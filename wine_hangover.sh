...
tar -xf wine.tar.xz
mv wine_hangover/arm64-v8a/bin /data/data/com.termux/files/usr/
mv wine_hangover/arm64-v8a/lib /data/data/com.termux/files/usr/
mv wine_hangover/arm64-v8a/share /data/data/com.termux/files/usr/
clear
